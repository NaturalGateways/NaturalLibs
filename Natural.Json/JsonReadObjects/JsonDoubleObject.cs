...
{
    internal class JsonDoubleObject : IJsonObject
    {
        #region Base
        ...
        public JsonDoubleObject(double doubleValue)
        {
        ...
        public JsonObjectType ObjectType { get { return JsonObjectType.Double; } }

        /// <summary>Getter for the object as a string.</summary>
        public string AsString { get { return m_doubleValue.ToString(); } }
        ...
        public double? AsDouble { get { return m_doubleValue; } }
