...
{
    internal class JsonBooleanObject : IJsonObject
    {
        #region Base
        ...
        public JsonBooleanObject(bool boolValue)
        {
        ...
        public JsonObjectType ObjectType { get { return JsonObjectType.Boolean; } }

        /// <summary>Getter for the object as a string.</summary>
        public string AsString { get { return m_boolValue ? "true" : "false"; } }
        ...
        public bool? AsBoolean { get { return m_boolValue; } }
